...
namespace WebApplication1.Services.Implements
{
    public class ClassroomService : IClassroomService
    {
        ...
        {
            var query = from studentClassroom in _context.StudentClassrooms
        ...
        {
            var list = _context.StudentClassrooms.Join(_context.Students, sc => sc.StudentId, s => s.Id,
        ...
        {
            var studentClassroomQuery = from studentClassroom in _context.StudentClassrooms
                                        join student in _context.Students on studentClassroom.StudentId equals student.Id
                                        where studentClassroom.ClassroomId == classroomId
                                        select student;
            ...
            var studentQuery = from studentClassroom in _context.StudentClassrooms
                        join student in _context.Students on studentClassroom.StudentId equals student.Id
