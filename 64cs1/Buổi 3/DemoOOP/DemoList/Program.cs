namespace DemoList
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Student[] arrSxGiam = students.OrderByDescending(s => s.Age).ToArray();

            for (int i = 0; i < arrSxGiam.Length; i++)
            {
                Console.WriteLine(arrSxGiam[i]);
            }
            ...
            Student find = students.FirstOrDefault(s => s.Name == "Cuong" && s.Age > 18);
            if (find != null)
            {
